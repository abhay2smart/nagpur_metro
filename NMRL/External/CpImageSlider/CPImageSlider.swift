...
class CPImageSlider: UIView, UIScrollViewDelegate {
	...
	var images = [String](){
		didSet{
            ...
            myPageControl.pageIndicatorTintColor = UIColor.white
            myPageControl.currentPageIndicatorTintColor = UIColor.hexStr(hexStr: "4BC6A8", alpha: 1)
			addImagesOnScrollView()
		}
	}
	...
	func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        //    print("index : \(currentIndex)")
            ...
            NotificationCenter.default.post(name: Notification.Name("GetIndexValue1"), object: currentIndex)
    ...
    @objc func slideImage()
	{
        ...
        NotificationCenter.default.post(name: Notification.Name("GetIndexValue"), object: currentIndex)
