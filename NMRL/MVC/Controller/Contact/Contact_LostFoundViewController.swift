...
class Contact_LostFoundViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate,UIDocumentPickerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet var LostButt: UIButton!
    ...
    override func viewDidLoad() {
        ...
        {
            Scroll.contentSize = CGSize(width : 0, height : 1230)
        }
        ...
        {
            Scroll.contentSize = CGSize(width : 0, height : 1330)
        }
        else if DeviceType.IS_IPHONE_X
        {
            Scroll.contentSize = CGSize(width : 0, height : 1530)
        }
        else if DeviceType.IS_IPHONE_XP
        {
            Scroll.contentSize = CGSize(width : 0, height : 1630)
        }
        ...
        LostButt.setTitle(LostArr[0], for: .normal)
...
//        else if DeviceType.IS_IPHONE_X
//        {
//            Scroll.contentSize = CGSize(width : 0, height : 1430)
//        }
//        else if DeviceType.IS_IPHONE_XP
//        {
//            Scroll.contentSize = CGSize(width : 0, height : 1530)
//        }
    ...
    @IBAction func LostClicked(_ sender: Any) {
        ...
        if tbl.isHidden == true
        {
            ...
            tbl.frame.origin.y = LostButt.frame.maxY + 2
            ...
            tbl.frame = CGRect(x: tbl.frame.origin.x, y: tbl.frame.origin.y, width: tbl.frame.width, height: 150)
        }
        else
        {
            tbl.isHidden = true
...
//            print("Mimie type : \(ImageMimeType!)")
            ...
            let url = "http://220.226.100.106:8000/saprestapi/LostandFound_Create?sap-client=120"
            ...
            ValueDic["i_lostnfound"] = LostButt.titleLabel?.text!
            ...
            TDict["tdline"] = LostButt.titleLabel?.text!//"Customer Feedback"
...
//            ArrMutable.add(TDict)
            ...
            FinalDict["create_lf_api"] = ValueDic
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let lbl = cell?.viewWithTag(1) as? UILabel
        {
            if tbl.tag == 1
            {
               lbl.text = ExperienceArr[indexPath.row]
                
            }
            else if tbl.tag == 2
            {
                lbl.text = LostArr[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if tbl.tag == 2
        {
            LostButt.setTitle(LostArr[indexPath.row], for: .normal)
