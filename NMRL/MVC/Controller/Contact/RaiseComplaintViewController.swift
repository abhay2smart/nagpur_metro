...
class RaiseComplaintViewController: UIViewController, UITextFieldDelegate, MFMailComposeViewControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        {
            Scroll.contentSize = CGSize(width : 0, height : 750)
        }
    ...
    func sendEmail(Email : String) {
        ...
        composeVC.setToRecipients([Email])
         composeVC.setSubject("Raise Complaint")
...
//    }
    ...
    @IBAction func Submit(_ sender: Any) {
        ...
        if MessageField.text == ""
                {
                     kAppDelegate.shared.showAlert(self, message: "Enter your complaint")
